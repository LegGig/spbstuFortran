module environment
   ...
   integer, parameter      :: L  = 32/REAL32
   integer, parameter      :: I_ = INT32  ! Разновидность типа для целочис. переменных.
   integer, parameter      :: R_ = REAL32 ! Разновидность типа для вещест. переменных.
